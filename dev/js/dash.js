...
revealTL.from("#road", {duration: 1.5, drawSVG: "0%", ease: "none"})
        ...
        // Weather
        .to("#cloud", {delay: .5, duration: .35, alpha: .25}, "cloud-blink")
        .to("#cloud", {duration: .35, alpha: 1}, "cloud-blink-on")
        .from("#touch", {delay: .5, duration: .35, alpha: 0, scale: 1.25, transformOrigin: "center"}, "cloud-blink")
        .to("#touch", {duration: .35, alpha: 0, scale: 2, transformOrigin: "center"}, "cloud-blink-on")
        ...
        .from("#direction4", {duration: .25, alpha: 0}, "music-blink")
        .to("#direction3", {duration: .25, alpha: 0}, "music-blink") 

        // Music
        .from("#touch2", {delay: .5, duration: .35, alpha: 0, scale: 1.25, transformOrigin: "center"}, "music-blink")
        .to("#touch2", {duration: .35, alpha: 0, scale: 2, transformOrigin: "center"}, "music-blink-on")
        .to("#music", {delay: .5, duration: .35, alpha: .25}, "music-blink")
        .to("#cloud", {duration: .35, alpha: 0, x: -150, y: 0}, "music-blink")
        .to("#music", {duration: .35, alpha: 1}, "music-blink-on")
        ...
        .to("#sped-arrow", {duration: .5, scale: 0, transformOrigin: "center"}, "cross2")
        .to("#minute", {duration: .5, scale: 0, transformOrigin: "center"}, "cross2")
        .to("#hour", {duration: .5, scale: 0, transformOrigin: "center"}, "cross2")
        .to("#fuel-level", {duration: .5, scale: 0, transformOrigin: "top"}, "cross2")
